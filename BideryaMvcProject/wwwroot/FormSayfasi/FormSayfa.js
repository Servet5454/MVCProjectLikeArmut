var turkiye_il_ilce = {
    ...
    "Afyon": ["Merkez", "Başmakçı", "Bayat", "Bolvadin", "Çay", "Çobanlar", "Dazkırı", "Dinar", "Emirdağ", "Evciler", "Hocalar", "İhsaniye", "İşcehisar", "Kızılören", "Sandıklı", "Sincanlı", "Suhut", "Sultandağı"],
    ...
    "Ankara": ["Altındağ", "Ayaş", "Akyurt", "Bala", "Beypazarı", "Çamlıdere", "Çankaya", "Çubuk", "Elmadağ", "Etimesgut", "Evren", "Gölbaşı", "Güdül", "Haymana", "Kahramankazan", "Kalecik", "Keçiören", "Kızılcahamam", "Mamak", "Nallıhan", "Polatlı", "Pursaklar", "Sincan", "Şereflikoçhisar", "Yenimahalle"],
    ...
    "Zonguldak": ["Merkez", "Alaplı", "Çaycuma", "Devrek", "Gökçebey", "Karadeniz Ereğli", "Kilimli", "Kozlu"],
...
function loadIller() {
    ...
    for (var il in turkiye_il_ilce) {
        var option = document.createElement("option");
        option.text = il;
        option.value = il; // İl değerini aynı şekilde metin olarak alalım
...
function loadIlceler(il) {
    ...
    var ilceler = turkiye_il_ilce[il];
    for (var i = 0; i < ilceler.length; i++) {
        var option = document.createElement("option");
        option.text = ilceler[i];
        option.value = ilceler[i]; // İlçe değerini aynı şekilde metin olarak alalım
