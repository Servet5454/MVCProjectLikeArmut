...
namespace BideryaMvcProject.Migrations
{
    ...
    [Migration("20230726194234_mig10")]
    partial class mig10
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BideryaMvcProject.DataBase.Entities.Hizmetler.HizmetKategori", b =>
                {
                    ...
                    b.Property<int>("HizmetKategorisi")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("TadilatDekorasyonId");
            ...
            modelBuilder.Entity("BideryaMvcProject.DataBase.Entities.Hizmetler.TadilatVeDekorasyon.TadilatDekorasyon", b =>
                {
                    ...
                    b.Property<int?>("CamBalkonId")
                        .HasColumnType("int");

                    b.Property<int?>("EvTadilatId")
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("MantolamaId")
                        .HasColumnType("int");

                    b.Property<int?>("MutfakDolabiYapimiId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("CamBalkonId");

                    b.HasIndex("EvTadilatId");

                    b.HasIndex("MantolamaId");

                    b.HasIndex("MutfakDolabiYapimiId");
            ...
            modelBuilder.Entity("BideryaMvcProject.DataBase.Entities.Hizmetler.Temizlik.TemizlikAna", b =>
                {
                    ...
                    b.Property<int?>("IlaclamaId")
                        .HasColumnType("int");

                    b.Property<int?>("KoltukTemizlikId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("AracYikamaId");

                    b.HasIndex("EvTemizlikId");

                    b.HasIndex("IlaclamaId");

                    b.HasIndex("KoltukTemizlikId");
            ...
            modelBuilder.Entity("BideryaMvcProject.DataBase.Entities.Kullanici.Kullanici", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            KayitTarihi = new DateTime(2023, 7, 26, 22, 42, 34, 704, DateTimeKind.Local).AddTicks(4744),
                            Sifre1 = "123456",
                            Sifre2 = "123456",
                            Soyad = "Yılmaz",
                            TelNo = "5551112233"
                        ...
                        new
                        {
                            ...
                            KayitTarihi = new DateTime(2023, 7, 26, 22, 42, 34, 704, DateTimeKind.Local).AddTicks(4746),
                            Sifre1 = "678900",
                            Sifre2 = "678900",
                            Soyad = "Kaya",
                            TelNo = "5554445566"
            ...
            modelBuilder.Entity("BideryaMvcProject.DataBase.Entities.Hizmetler.HizmetKategori", b =>
                {
                    b.HasOne("BideryaMvcProject.DataBase.Entities.Hizmetler.TadilatVeDekorasyon.TadilatDekorasyon", "TadilatDekorasyon")
                        .WithMany()
                        .HasForeignKey("TadilatDekorasyonId");

                    b.HasOne("BideryaMvcProject.DataBase.Entities.Hizmetler.Temizlik.TemizlikAna", "TemizlikAna")
                        .WithMany()
                        .HasForeignKey("TemizlikAnaId");

                    b.Navigation("TadilatDekorasyon");
            ...
            modelBuilder.Entity("BideryaMvcProject.DataBase.Entities.Hizmetler.TadilatVeDekorasyon.TadilatDekorasyon", b =>
                {
                    b.HasOne("BideryaMvcProject.DataBase.Entities.Hizmetler.TadilatVeDekorasyon.CamBalkon", "CamBalkon")
                        .WithMany()
                        .HasForeignKey("CamBalkonId");

                    b.HasOne("BideryaMvcProject.DataBase.Entities.Hizmetler.TadilatVeDekorasyon.EvTadilat", "EvTadilat")
                        .WithMany()
                        .HasForeignKey("EvTadilatId");

                    b.HasOne("BideryaMvcProject.DataBase.Entities.Hizmetler.TadilatVeDekorasyon.Mantolama", "Mantolama")
                        .WithMany()
                        .HasForeignKey("MantolamaId");

                    b.HasOne("BideryaMvcProject.DataBase.Entities.Hizmetler.TadilatVeDekorasyon.MutfakDolabiYapimi", "MutfakDolabiYapimi")
                        .WithMany()
                        .HasForeignKey("MutfakDolabiYapimiId");
            ...
            modelBuilder.Entity("BideryaMvcProject.DataBase.Entities.Hizmetler.Temizlik.TemizlikAna", b =>
                {
                    b.HasOne("BideryaMvcProject.DataBase.Entities.Hizmetler.Temizlik.AracYikama", "AracYikama")
                        .WithMany()
                        .HasForeignKey("AracYikamaId");

                    b.HasOne("BideryaMvcProject.DataBase.Entities.Hizmetler.Temizlik.EvTemizlik", "EvTemizlik")
                        .WithMany()
                        .HasForeignKey("EvTemizlikId");

                    b.HasOne("BideryaMvcProject.DataBase.Entities.Hizmetler.Temizlik.Ilaclama", "Ilaclama")
                        .WithMany()
                        .HasForeignKey("IlaclamaId");

                    b.HasOne("BideryaMvcProject.DataBase.Entities.Hizmetler.Temizlik.KoltukTemizlik", "KoltukTemizlik")
                        .WithMany()
                        .HasForeignKey("KoltukTemizlikId");
