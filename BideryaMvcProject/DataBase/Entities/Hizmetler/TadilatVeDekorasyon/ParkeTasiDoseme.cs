...
namespace BideryaMvcProject.DataBase.Entities.Hizmetler.TadilatVeDekorasyon
{
    public class ParkeTasiDoseme
    {
        ...
        public int IlanAltKategoriId { get; set; } = Convert.ToInt32(AltKategoriEnum.TadilatVeDekorasyonHizmetleri.ParkeTasiDoseme);
        public string? IlanBaslik { get; set; } = "Parke Taşı Döşeme";
