...
namespace BideryaMvcProject.DataBase.Entities.Hizmetler.TadilatVeDekorasyon
{
    public class EvDekorasyon
    {
        ...
        public int IlanAltKategoriId { get; set; } = Convert.ToInt32(AltKategoriEnum.TadilatVeDekorasyonHizmetleri.EvDekorasyon);
        public string? IlanBaslik { get; set; } = "Ev Dekorasyon";
