...
namespace BideryaMvcProject.DataBase.Entities.Hizmetler.TadilatVeDekorasyon
{
    public class GunesEnerjisi
    {
        ...
        public int IlanAltKategoriId { get; set; } = Convert.ToInt32(AltKategoriEnum.TadilatVeDekorasyonHizmetleri.GunesEnerjisi);
        public string? IlanBaslik { get; set; } = "Güneş Enerjisi";
