...
{
    public class OzelMobilyaYapimi
    {
        ...
        public int IlanAltKategoriId { get; set; } = Convert.ToInt32(AltKategoriEnum.TadilatVeDekorasyonHizmetleri.OzelMobilyaYapimi);
        public string? IlanBaslik { get; set; } = "Özel Mobilya Yapımı";
