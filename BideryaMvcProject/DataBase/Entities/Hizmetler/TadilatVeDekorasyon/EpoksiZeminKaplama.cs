...
{
    public class EpoksiZeminKaplama
    {
        ...
        public int IlanAltKategoriId { get; set; } = Convert.ToInt32(AltKategoriEnum.TadilatVeDekorasyonHizmetleri.EpoksiZeminKaplama);
        public string? IlanBaslik { get; set; } = "Epoksi Zemin Kaplama";
