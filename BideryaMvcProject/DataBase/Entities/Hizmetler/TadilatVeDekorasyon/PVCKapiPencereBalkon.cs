...
{
    public class PVCKapiPencereBalkon
    {
        ...
        public int IlanAltKategoriId { get; set; } = Convert.ToInt32(AltKategoriEnum.TadilatVeDekorasyonHizmetleri.PVCKapiPencereBalkon);
        public string? IlanBaslik { get; set; } = "Pvc Kapı Pencere Balkon";
