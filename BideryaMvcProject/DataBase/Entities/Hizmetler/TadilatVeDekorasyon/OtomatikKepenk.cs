...
namespace BideryaMvcProject.DataBase.Entities.Hizmetler.TadilatVeDekorasyon
{
    public class OtomatikKepenk
    {
        ...
        public int IlanAltKategoriId { get; set; } = Convert.ToInt32(AltKategoriEnum.TadilatVeDekorasyonHizmetleri.OtomatikKepenk);
        public string? IlanBaslik { get; set; } = "Otomatik Kepenk";
