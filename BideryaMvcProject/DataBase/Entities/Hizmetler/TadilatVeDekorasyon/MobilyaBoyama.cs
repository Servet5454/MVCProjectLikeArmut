...
namespace BideryaMvcProject.DataBase.Entities.Hizmetler.TadilatVeDekorasyon
{
    public class MobilyaBoyama
    {
        ...
        public int IlanAltKategoriId { get; set; } = Convert.ToInt32(AltKategoriEnum.TadilatVeDekorasyonHizmetleri.MobilyaBoyama);
        public string? IlanBaslik { get; set; } = "Mobilya Boyama";
