...
namespace BideryaMvcProject.DataBase.Entities.Hizmetler.TadilatVeDekorasyon
{
    public class ParkeSistreCila
    {
        ...
        public int IlanAltKategoriId { get; set; } = Convert.ToInt32(AltKategoriEnum.TadilatVeDekorasyonHizmetleri.ParkeSistreCila);
        public string? IlanBaslik { get; set; } = "Parke Sistre Cila";
